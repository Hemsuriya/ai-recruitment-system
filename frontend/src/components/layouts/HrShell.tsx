  ...
  return (
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex flex-1 flex-col">
        <div className="flex h-[56px] items-center justify-between border-b border-gray-200 bg-white px-5">
          <div className="flex w-full max-w-[372px] items-center gap-2 rounded-xl border border-gray-200 bg-gray-50 px-3 py-1.5">
